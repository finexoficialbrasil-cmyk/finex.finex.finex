    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <Card className={`glass-card border-0 ${weather.bg} relative overflow-hidden`}>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              >
                <WeatherIcon className={`w-20 h-20 ${weather.color} mb-4`} />
              </motion.div>
        ...
        <motion.div
          ...
          className="absolute -bottom-20 -left-20 w-64 h-64 bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-full blur-3xl"
        />
      </Card>
